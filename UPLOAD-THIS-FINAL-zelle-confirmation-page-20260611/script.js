  ...
  orderConfirmation.innerHTML = `
    ...
    <section class="order-detail-panel">
      ...
      <div class="order-table">
        ...
        <div class="order-table-row"><span>Handling</span><strong>${formatPrice(totals.handlingValue)}</strong></div>
        <div class="order-table-row"><span>Processing</span><strong>${formatPrice(totals.processingValue)}</strong></div>
